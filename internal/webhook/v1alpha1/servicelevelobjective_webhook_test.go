...
var _ = Describe("ServiceLevelObjective Webhook", func() {
	var (
		obj       *srev1alpha1.ServiceLevelObjective
		oldObj    *srev1alpha1.ServiceLevelObjective
		validator ServiceLevelObjectiveCustomValidator
		defaulter ServiceLevelObjectiveCustomDefaulter
	)
	...
	Context("When creating ServiceLevelObjective under Defaulting Webhook", func() {
